...
describe Admin::ContentElementTextsController do
  ...
  before(:each) do
    ...
    @content_element_text = mock_model(ContentElementText, :content_element => @content_element, :destroy => true, :page => @page, :template_part_id => 1)
    ContentElementText.stub!(:find).and_return(@content_element_text)
    login_admin
  end
  ...
  describe "find_element" do
    ...
    it "should exist" do
      Admin::ContentElementTextsController.filter_chain.find(:find_element).should_not be_nil
    end
    
    it "should find the content element requested" do
      ContentElementText.should_receive(:find)
      controller.send :find_element
    end
    
    it "should save the content element requested in a instance variable" do
      controller.send :find_element
      controller.send(:instance_variable_get, :@content_element).should equal @content_element_text
    end
    
  end
  
  describe "GET /admin/pages/1/content_element_texts/1/edit" do
  ...
  describe "PUT /admin/pages/1/content_element_texts/1" do
    ...
    before(:each) do
      @content_element_text.stub!(:update_attributes).and_return(true)
    end
    ...
    it "should update the attributes of the content element requested" do
      @content_element_text.should_receive(:update_attributes)
      xhr :put, :update, :content_page_id => 1, :id => 1
    end
    ...
    it "should add /uploading_failed/ as flash, if the text did not get saved" do
      @content_element_text.stub!(:update_attributes).and_return(false)
      @controller.instance_eval { flash.extend(DisableFlashSweeping) }
      xhr :put, :update, :content_page_id => 1, :id => 1
  ...
  describe "DELETE /admin/pages/1/content_element_texts/1" do
    ...
    it "should delete the content element requested" do
      @content_element_text.should_receive(:destroy)
      xhr :delete, :destroy, :content_page_id => 1, :id => 1
    end
    
    it "should add /deleted_succesfully/ as flash" do
      @controller.instance_eval { flash.extend(DisableFlashSweeping) }
      xhr :delete, :destroy, :content_page_id => 1, :id => 1
